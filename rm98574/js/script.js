//Criar uma lista de alunos em um array
let nomesAlunosArray = ["Pedro","Luis","Carlos","Maria","Joice","Otávio","Antônio","Filipe","Jailson","Rony"]
...
nomesAlunosArray.forEach((aluno) => {//Imprime cada elemento no console
   console.log(`${aluno}`);});
